import multiplayerframe from './components/multiplayer/multiplayer.js?ver=1.2.2';
import ChartSelectPageComponent from './components/chartselect/chartselect.js?ver=1.2.2';
import StartPageComponent from './components/startpage/startpage.js?ver=1.2.2';
import ChartDetailsPageComponent from './components/chartdetails/chartdetails.js?ver=1.2.2';
import PlayingPageComponent from './components/playing/playing.js?ver=1.2.2';
import LoginPageComponent from './components/login/login.js?ver=1.2.2';
import CalibratePageComponent from './components/calibrate/calibrate.js?ver=1.2.2';
import CacheManagePageComponent from './components/cachemanage/cachemanage.js?ver=1.2.2';
import AboutPageComponent from './components/aboutpage/aboutpage.js?ver=1.2.2';
import UserChartUploadComponent from './components/userChartUpload/userChartUpload.js?ver=1.2.2';
import UserChartEditComponent from './components/userChartEdit/userChartEdit.js?ver=1.2.2';
import PlayerB20Component from './components/playerB20/playerB20.js?ver=1.2.2';
import PZRankSingleComponent from './components/pzRankSingle/pzRankSingle.js?ver=1.2.2';

import { uploader } from './utils/js/reader.js?ver=1.2.2';
import shared from './utils/js/shared.js?ver=1.2.2';
import phizoneApi from './utils/js/phizoneApi.js?ver=1.2.2';
import { full } from './utils/js/common.js?ver=1.2.2';
import { tipsHandler } from './components/tips/tips.js?ver=1.2.2';
...
const ptAppInstance = Vue.createApp({
    ...
    methods: {
        ...
        async playFinished() {
            if (shared.game.multiInstance.room.compete_mode && shared.game.multiInstance.owner) {
                scoreLoadingAndResultData.display = false;
                return;
            }
            const chartData = JSON.parse(sessionStorage.getItem('loadedChart'));
            const shouldNotUploadPhiZone = this.noAccountMode || typeof chartData.id !== 'number' || this.gameConfig.idn1;
        ...
        async playerLoaded() {
            ...
            const requestFullscreen = async () => {
                if(![80, 443, 1443, "1443", ""].includes(location.port)) return;
