...
import { checkLocalChart } from '../cachemanage/cacheutils.js?ver=1.2.2';
                ...
                <div class="scoreSongCard">
                  ...
                  <div class="songCardCover" :style="{'--bg':'url('+round.chartInfo.songData.illustration+')'}">
                    <div class="songCardName">
                      {{round.chartInfo.songData.name}} ({{round.chartInfo.speedInfo.disp}})
                    </div>
        ...
        loadChartSecond(songInfo, chartInfo) {
            ...
            const updateLoadFinish = async () => {
                try {
                    ...
                    const shouldNotUploadPhiZone = this.noAccountMode || typeof chartData.id !== 'number';
