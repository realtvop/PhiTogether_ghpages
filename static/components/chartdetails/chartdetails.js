...
import { audio } from '../../utils/js/aup.js?ver=1.2.2';
import { deleteCacheInArray } from "../cachemanage/cacheutils.js?ver=1.2.2";
export default {
    name: 'chartDetails',
    template: `
    <div style="margin-top:2em;" id="chartDetails" v-if="data">
        <div id="chartDetailsHeader">
            ...
            <div id="chartSongDetails">
                ...
                <div style="display: flex;justify-content: space-evenly;flex-wrap: wrap;" v-if="!canFav && isSingle">
                    <a @click="edit">编辑</a>
