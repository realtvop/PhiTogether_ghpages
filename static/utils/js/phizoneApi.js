import shared from './shared.js?ver=1.2.2';
...
const getApi = (e) => shared.game.ptmain.gameConfig.apiSource + API_PATH[e];
    ...
    getUserBasicInfo(access_token) {
        return new Promise(async (res, rej) => {
            try {
                ...
                result.isPTDeveloper = ["400c3241004b5db7ca7f5abfef2794f2", "19f3cd308f1455b3fa09a282e0d496f4", "46771d1f432b42343f56f791422a4991", "21e4ef94f2a6b23597efabaec584b504", "ca460332316d6da84b08b9bcf39b687b"].includes(md5(`${result.id}`));
    ...
    getRecords(access_token, chart=null, page=null, link=null) {
        return new Promise(async (res, rej) => {
            try {
				...
				else link = link.replace(/https?:\/\/api.phi.zone/, shared.game.ptmain.gameConfig.apiSource);
