import { csv2array } from "./common.js?ver=1.2.2";
import Pec from "./pec2json.js?ver=1.2.2";
...
export class ZipReader extends EventTarget {
  ...
  read(result) {
    if (!this.worker) {
      ...
      const worker = new Worker("/static/utils/js/zip.js?ver=1.2.2"); //以后考虑indexedDB存储url
